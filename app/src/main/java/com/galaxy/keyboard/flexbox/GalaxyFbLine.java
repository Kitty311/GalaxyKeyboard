...
public class GalaxyFbLine {
    ...
    /**
     * Set to true if any {@link GalaxyFbItem}s in this line have {@link GalaxyFbItem#getFlexGrow()}
     * attributes set (have the value other than {@link GalaxyFbItem#FLEX_GROW_DEFAULT})
     */
    boolean mAnyItemsHaveFlexGrow;

    /**
     * Set to true if any {@link GalaxyFbItem}s in this line have {@link GalaxyFbItem#getFlexShrink()}
     * attributes set (have the value other than {@link GalaxyFbItem#FLEX_SHRINK_NOT_SET})
     */
