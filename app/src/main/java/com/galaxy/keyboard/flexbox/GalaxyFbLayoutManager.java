...
public class GalaxyFbLayoutManager extends RecyclerView.LayoutManager implements GalaxyFbContainer,
     ...
     */
    private boolean mFromBottomToTop = true;
    ...
    private GalaxyFbLayoutManager.AnchorInfo mAnchorInfo = new GalaxyFbLayoutManager.AnchorInfo();
     ...
     */
    private GalaxyFbHelper.FlexLinesResult mFlexLinesResult = new GalaxyFbHelper.FlexLinesResult();
