...
interface GalaxyFbContainer {
     ...
     */
    List<GalaxyFbLine> getFlexLines();
     ...
     */
    void onNewFlexItemAdded(View view, int index, int indexInFlexLine, GalaxyFbLine flexLine);
     ...
     */
    void onNewFlexLineAdded(GalaxyFbLine flexLine);
     ...
     */
    void setFlexLines(List<GalaxyFbLine> flexLines);
    ...
    List<GalaxyFbLine> getFlexLinesInternal();
