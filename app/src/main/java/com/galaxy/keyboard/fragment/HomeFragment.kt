...
class HomeFragment : Fragment() {
    ...
    override fun onStart() {
        ...
        if (mShouldEnable) {
            mEnableButton!!.backgroundTintList = (ContextCompat.getColorStateList(_context!!,
                R.color.enableButtonColor))
            mEnableButton!!.text = _context!!.getString(R.string.enable_keyboard)
            ...
            mEnableButton!!.text = _context!!.getString(R.string.switch_keyboard)
        ...
        mLoginButton!!.backgroundTintList = (ContextCompat.getColorStateList(_context!!,
            if (mShouldLogin) R.color.loginButtonColor else R.color.logoutButtonColor))
        mLoginButton!!.text = _context!!.getString(if (mShouldLogin) R.string.login else R.string.logout)
    }
